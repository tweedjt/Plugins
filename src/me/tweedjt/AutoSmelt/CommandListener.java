			...
			if (sender != null) {
				...
				if (sender instanceof Player) {
					...
					if (AutoSmelt.getInstance().hasSmelt(player.getUniqueId())) {
						// Util.logToConsole("Player has smelt on - turn it off"); // Comment this out
						// for release
						...
						// Util.logToConsole("Player has smelt off - turn it on"); // Comment this out
						// for release
						// Player already has smelt on - turn it off
					...
					// Util.logToConsole("Command was run by console"); // Comment this out for
					// release
